...
import { obtenirAnunciPerId, actualitzarAnunci } from '../services/anuncioService';
...
const EditarAnuncioPage: React.FC = () => {
  ...
  const fetchAnunci = async () => {
    try {
      ...
      // Dades originals per a restaurar si es cancel·la l'edició
  ...
  // Funcio per gestionar el canvi de l'estat de la geolocalització
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Si s'ha activat la geolocalització ara, guardar la ubicació inicial de la mascota
    ...
    <div style={styles.container}>
      ...
      <div style={isMobile ? { padding: '20px' } : styles.desktopLayout}>
        <div style={isMobile ? {} : styles.formSection}>
          <h2 style={styles.title}>Editar Anunci</h2>
